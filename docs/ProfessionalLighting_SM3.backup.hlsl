...
// Shader Model 3.0 "maximum beauty" profile.
// Built as a separate high-quality variant from the stable SM2 shader.
//
// Key upgrades vs SM2:
// - higher quality 2D anisotropic blur sampling for bar fill
// - stronger anti-banding and anti-stripe behavior
// - tighter seam guard to avoid contaminating active video area
// - richer filmic grading for ambient zones
